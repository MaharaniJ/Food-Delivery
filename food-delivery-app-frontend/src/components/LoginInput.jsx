...
function LoginInput({placeHolder,icon,inputState,inputStateFunc,type,isSignUp}) {
  ...
  return (
    ...
    variants={fadeInout}
    // {...fadeInout}
    className={`text-black-100 flex items-center justify-center gap-4 bg-lightOverlay backdrop-blur-md rounded-md w-full px-4 py-2 ${isFocus ? "shadow-md shadow-red-400" : "shadow-none"}`}>
        {icon}
